import pygame
from Classes.EMPboots import EMPboots
...
def init_wave_1():
    ...
    player.boots = EMPboots(player)
    player2 = Player(100, 100, 12*3, 21*3, player, speed=10)
...
def main():
    ...
    collectable = JetbootsItem(200, 300, 50, 50, image_path="./Resources/jetboots.png", item_type="weapon", value=10)
